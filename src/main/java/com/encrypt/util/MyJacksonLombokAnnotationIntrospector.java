...
import com.xebia.jacksonlombok.ProxyAnnotation;

public class MyJacksonLombokAnnotationIntrospector extends JacksonAnnotationIntrospector {
    ...
    public String findImplicitPropertyName(AnnotatedMember member) {
        ...
        if (property == null) {
            if (member instanceof AnnotatedMethod) {
                ...
                String fieldName = BeanUtil.okNameForGetter(method,true);
